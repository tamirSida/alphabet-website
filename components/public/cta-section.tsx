  ...
  return (
    <section className="py-16 sm:py-24 px-4 bg-gradient-to-r from-white via-white to-gray-200 text-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed mb-8 sm:mb-12 max-w-3xl mx-auto">
          {description}
        </p>
        ...
        <div className="mt-12 sm:mt-16 pt-8 border-t border-gray-700">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-gray-400">
